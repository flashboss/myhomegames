...
describe('Directory Structure Initialization', () => {
  ...
  test('should create metadata directories and files automatically on startup', () => {
    ...
    const expectedDirectories = [
      tempMetadataPath,
      path.join(tempMetadataPath, 'metadata'),
    ...
    const expectedFiles = [
      path.join(tempMetadataPath, 'metadata', 'games-library.json'),
      path.join(tempMetadataPath, 'metadata', 'games-collections.json'),
      path.join(tempMetadataPath, 'metadata', 'games-recommended.json'),
      path.join(tempMetadataPath, 'metadata', 'games-categories.json'),
    ];
  ...
  test('should not fail if directories already exist', () => {
    ...
    fs.mkdirSync(path.join(tempMetadataPath, 'metadata'), { recursive: true });
    ...
    expect(fs.existsSync(path.join(tempMetadataPath, 'metadata'))).toBe(true);
