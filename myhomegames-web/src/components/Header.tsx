...
export default function Header({ allGames, onGameSelect, onHomeClick, onSettingsClick, onAddGameClick }: HeaderProps) {
  return (
    <header className="plex-header">
      <div className="plex-header-container">
        ...
        <div className="plex-header-actions">
          ...
          <button className="plex-header-button" aria-label="Settings" onClick={onSettingsClick}>
